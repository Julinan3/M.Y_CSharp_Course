...
namespace CSharp_Course601_Solution
{
    public partial class FrmEmployee : Form
    {
        ...
        string connectionString = "Server=localhost;port=5432;Database=CostumberDb;userId=postgres;password=1234";
        void EmployeeList()
        {
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            int depatmentId = int.Parse(cmbEmployeeDepartment.SelectedValue.ToString());
            ...
            command.Parameters.AddWithValue("@departmentId", depatmentId);
